...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATank_Statics::NewProp_TankSpringArm = { "TankSpringArm", nullptr, (EPropertyFlags)0x00400000000a0009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATank, TankSpringArm), Z_Construct_UClass_USpringArmComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ATank_Statics::NewProp_TankSpringArm_MetaData), Z_Construct_UClass_ATank_Statics::NewProp_TankSpringArm_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATank_Statics::NewProp_TankCamera = { "TankCamera", nullptr, (EPropertyFlags)0x00400000000a0009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATank, TankCamera), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ATank_Statics::NewProp_TankCamera_MetaData), Z_Construct_UClass_ATank_Statics::NewProp_TankCamera_MetaData) };
#if WITH_METADATA
	...
	ATank::~ATank() {}
	struct Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_ToonTanksProjectSetup_4_25_ToonTanks_5_3_Source_ToonTanks_Tank_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_ToonTanksProjectSetup_4_25_ToonTanks_5_3_Source_ToonTanks_Tank_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATank, ATank::StaticClass, TEXT("ATank"), &Z_Registration_Info_UClass_ATank, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATank), 491525324U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_ToonTanksProjectSetup_4_25_ToonTanks_5_3_Source_ToonTanks_Tank_h_1819816131(TEXT("/Script/ToonTanks"),
		Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_ToonTanksProjectSetup_4_25_ToonTanks_5_3_Source_ToonTanks_Tank_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_ToonTanksProjectSetup_4_25_ToonTanks_5_3_Source_ToonTanks_Tank_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
