...
// End Cross Module References
	DEFINE_FUNCTION(UHealthComponent::execDamageTaken)
	{
		...
		P_GET_PROPERTY(FFloatProperty,Z_Param_Damge);
		P_GET_OBJECT(UDamageType,Z_Param_DamageType);
		P_GET_OBJECT(AController,Z_Param_Instigator);
		P_GET_OBJECT(AActor,Z_Param_DamageCauser);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->DamageTaken(Z_Param_DamagedActor,Z_Param_Damge,Z_Param_DamageType,Z_Param_Instigator,Z_Param_DamageCauser);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_UHealthComponent_DamageTaken_Statics
	{
		...
		static const UECodeGen_Private::FFloatPropertyParams NewProp_Damge;
#if WITH_METADATA
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHealthComponent_DamageTaken_Statics::NewProp_Damge = { "Damge", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(HealthComponent_eventDamageTaken_Parms, Damge), METADATA_PARAMS(0, nullptr) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UHealthComponent_DamageTaken_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UHealthComponent_DamageTaken_Statics::NewProp_Damge,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHealthComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHealthComponent_DamageTaken, "DamageTaken" }, // 433215155
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_ToonTanksProjectSetup_4_25_ToonTanks_5_3_Source_ToonTanks_HealthComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_ToonTanksProjectSetup_4_25_ToonTanks_5_3_Source_ToonTanks_HealthComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHealthComponent, UHealthComponent::StaticClass, TEXT("UHealthComponent"), &Z_Registration_Info_UClass_UHealthComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHealthComponent), 3887777030U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_ToonTanksProjectSetup_4_25_ToonTanks_5_3_Source_ToonTanks_HealthComponent_h_3773931693(TEXT("/Script/ToonTanks"),
		Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_ToonTanksProjectSetup_4_25_ToonTanks_5_3_Source_ToonTanks_HealthComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_kacpe_Documents_Unreal_Projects_ToonTanksProjectSetup_4_25_ToonTanks_5_3_Source_ToonTanks_HealthComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
